...
На данном этапе мы определили нужные нам параметры, спарсили данные с Циана (которые можно найти в таблице в файле под названием dataset_cian_itog.csv, а также результаты самого парсинга в файле Парсинг.ipynb), и выяснили корреляционную зависимость факторов и их значение для нашей модели.
